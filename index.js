...
let total = (youtubePremium + peacock + disney + hulu + netflix)
...
let newTotal = (hulu + peacock + netflix + disney + youtubePremium)
...
console.log(`Your savings are: ${savings}%`)
